			...
			$canvas.signature({
				...
				change: function(event, ui) { 
				    ...
				    if( $target.signature('isEmpty')==false ) {
						...
						//document.write('<img src="'+$image_data_url+'"/>');
						//$field.val(src);

						//console.log($target.signature('toSVG'));
				    	//$field.val($target.signature('toSVG'));

				    	/*
				    	var thumbnail = $canvas.children('canvas'); 
						var thumb_jpeg = thumbnail.toDataURL("image/jpeg");
						console.log(thumb_jpeg);
						*/
